...
namespace IronBasic.Types
{
    ...
    public class MbfSingle : MbfFloat
    {
        ...
        public static readonly MbfSingle Ten = FromBytes(0x00, 0x00, 0x20, 0x84);
        ...
        public MbfSingle(bool isNegitive = false, BigInteger mantisa = default(BigInteger), byte exponent = 0)
        ...
        public static MbfSingle FromBytes(byte b1, byte b2, byte b3, byte b4)
        {
            ...
            var mantisa = (b3 | 0x80U) * (ulong)Math.Pow(0x100, ByteSize - 2);

            // 0, 1
            mantisa += b1 + b2 * 0x100U;
            mantisa <<= 8;
